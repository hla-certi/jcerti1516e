...
/**
 * <code>CertiMessage</code> represents one of the messages which are exchanged
 * between the federate and the RTIA. It contains the information that are used
 * in all messages (the <code>CertiMessageType</code> of the message, its
 * <code>CertiExceptionType</code> and its <code>FederationTime</code>). It is
 * also responsible for handling of writing the message header to the
...
public class CertiMessage {
	...
	/**
	 * Creates a new instance of <code>CertiMessage</code>. The default
	 * initialization sets message type to NOT_USED, exception type to NO_EXCEPTION
	 * and federation time to 0.
	 */
	public CertiMessage() {
	...
	/**
	 * Creates a new instance of <code>CertiMessage</code> with specified message
	 * type.
	 *
	...
	/**
	 * Writes in the <code>MessageBuffer</code> the state of the attributes of the
	 * <code>CertiMessage</code>. The order will be the
	 * <code>CertiMessageType</code>, the <code>CertiExceptionType</code> and the
	 * federation time of the <code>CertiMessage</code>.
	 *
	 * @param messageBuffer the <code>MessageBuffer</code> in which the method will
	 *                      write the state of the <code>CertiMessage</code>
	 */
	 ...
	 *
	 * @param messageBuffer the <code>MessageBuffer</code> from which the method
	 *                      will read the state of the <code>CertiMessage</code>
	...
	public void readMessage(MessageBuffer messageBuffer) throws CertiException {
		...
		synchronized (messageBuffer) {
			...
			if (this.exception != CertiExceptionType.NO_EXCEPTION) {
				// If the message carry an exception, the Body will only contain the exception
				// reason.

				throw new CertiException(this.exception, messageBuffer.readString()); // Reads the reason and throws the
																						// exception
			}
			// BASIC MESSAGE
	...
	/**
	 * Returns the <code>CertiExceptionType</code> of this
	...
	/**
	 * This function is able to give a <code>String</code> which represents the
	 * state of the message. It gives its <code>CertiMessageType</code>, its
	 * <code>CertiExceptionType</code> and the federation time.
	 *
