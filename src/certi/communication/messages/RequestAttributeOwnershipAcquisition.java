...
public class RequestAttributeOwnershipAcquisition extends CertiMessage {
   private int object;
   private AttributeHandleSet attributes;

   public RequestAttributeOwnershipAcquisition() {
      super(CertiMessageType.REQUEST_ATTRIBUTE_OWNERSHIP_ACQUISITION);
   }
