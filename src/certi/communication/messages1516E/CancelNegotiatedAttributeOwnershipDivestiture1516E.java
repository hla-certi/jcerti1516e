...
public class CancelNegotiatedAttributeOwnershipDivestiture1516E extends CertiMessage1516E {
   private int object;
   private AttributeHandleSet attributes;

   public CancelNegotiatedAttributeOwnershipDivestiture1516E() {
      super(CertiMessageType.CANCEL_NEGOTIATED_ATTRIBUTE_OWNERSHIP_DIVESTITURE);
   }
