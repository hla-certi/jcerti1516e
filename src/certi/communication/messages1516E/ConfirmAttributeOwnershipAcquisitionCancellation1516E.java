...
public class ConfirmAttributeOwnershipAcquisitionCancellation1516E extends CertiMessage1516E {
   private int object;
   private AttributeHandleSet attributes;

   public ConfirmAttributeOwnershipAcquisitionCancellation1516E() {
      super(CertiMessageType.CONFIRM_ATTRIBUTE_OWNERSHIP_ACQUISITION_CANCELLATION);
   }
