...
public class GetInteractionClassName1516E extends CertiMessage1516E {
	private int interactionClass;
	private String className;

	public GetInteractionClassName1516E() {
		super(CertiMessageType.GET_INTERACTION_CLASS_NAME);
	}
