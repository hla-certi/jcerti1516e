...
public class InformAttributeOwnership1516E extends CertiMessage1516E {
   private int object;
   private int attribute;
   private int federate;

   public InformAttributeOwnership1516E() {
      super(CertiMessageType.INFORM_ATTRIBUTE_OWNERSHIP);
   }
