...
public class PublishInteractionClass1516E extends CertiMessage1516E {
   private int interactionClass;

   public PublishInteractionClass1516E() {
      super(CertiMessageType.PUBLISH_INTERACTION_CLASS);
   }
