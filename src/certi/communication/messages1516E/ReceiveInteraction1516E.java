...
public class ReceiveInteraction1516E extends CertiMessage1516E {
	...
	public void readMessage(MessageBuffer messageBuffer) throws CertiException {
		...
		if (sizeKeys != sizeValues) {
			throw new CertiException(CertiExceptionType.ARRAY_INDEX_OUT_OF_BOUNDS,
					"Error while reading parameterHandleValueMap : values size doesn't match with hanldes size");
		}
	...
	public String toString() {
		return (super.toString() + ", interactionClass: " + interactionClass + ", ParameterHandleValuePairSet: "
				+ parameterHandleValueMap.toString() + ", region: " + region + ", EventRetractionHandle: "
