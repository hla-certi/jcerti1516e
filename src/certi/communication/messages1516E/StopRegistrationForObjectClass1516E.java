...
public class StopRegistrationForObjectClass1516E extends CertiMessage1516E {
	private int objectClass;

	public StopRegistrationForObjectClass1516E() {
		super(CertiMessageType.STOP_REGISTRATION_FOR_OBJECT_CLASS);
	}
