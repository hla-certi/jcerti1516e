...
public class UnsubscribeInteractionClass1516E extends CertiMessage1516E {
	private int interactionClass;

	public UnsubscribeInteractionClass1516E() {
		super(CertiMessageType.UNSUBSCRIBE_INTERACTION_CLASS);
	}
