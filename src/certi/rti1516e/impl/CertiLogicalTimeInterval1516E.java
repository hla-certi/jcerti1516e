...
public class CertiLogicalTimeInterval1516E implements LogicalTimeInterval{
    ...
    public static final CertiLogicalTimeInterval1516E POSITIVE_INFINITY = new CertiLogicalTimeInterval1516E(Double.MAX_VALUE);
    ...
    @Override
    public LogicalTimeInterval add(LogicalTimeInterval addend) throws IllegalTimeArithmetic, InvalidLogicalTimeInterval {
    ...
    @Override
    public LogicalTimeInterval subtract(LogicalTimeInterval subtrahend) throws IllegalTimeArithmetic, InvalidLogicalTimeInterval {
