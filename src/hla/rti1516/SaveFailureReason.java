...
public final class SaveFailureReason implements java.io.Serializable {
  ...
  /**
  This is the only public constructor. Each user-defined instance of a SaveFailureReason
  ...
  * @return true if supplied object is of type SaveFailureReason and has same value;
  false otherwise
  */
