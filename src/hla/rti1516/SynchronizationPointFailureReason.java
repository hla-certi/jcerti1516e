...
public final class SynchronizationPointFailureReason implements java.io.Serializable {
  ...
  */
  ...
  throws RTIinternalError
  {
    ...
    if (value < _lowestValue || value >= _nextToAssign) throw new
      RTIinternalError("SynchronizationPointFailureReason: illegal value " + value);
  }
  ...
  */
  ...
  static public final SynchronizationPointFailureReason
    SYNCHRONIZATION_POINT_LABEL_NOT_UNIQUE = new SynchronizationPointFailureReason();
  static public final SynchronizationPointFailureReason
    SYNCHRONIZATION_SET_MEMBER_NOT_JOINED = new SynchronizationPointFailureReason();
}
