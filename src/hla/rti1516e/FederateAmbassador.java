...
////////////////////////////////////
	...
	// 4.4
	void connectionLost(String faultDescription) throws FederateInternalError;
	...
	// 4.17
	void initiateFederateSave(String label, LogicalTime time) throws FederateInternalError;
	...
	// 4.27
	void initiateFederateRestore(String label, String federateName, FederateHandle federateHandle)
			throws FederateInternalError;
	...
	// 4.32
	void federationRestoreStatusResponse(FederateRestoreStatus[] response) throws FederateInternalError;
...
/////////////////////////////////////
	...
	// 5.10
	void startRegistrationForObjectClass(ObjectClassHandle theClass) throws FederateInternalError;

	// 5.11
	void stopRegistrationForObjectClass(ObjectClassHandle theClass) throws FederateInternalError;

	// 5.12
	void turnInteractionsOn(InteractionClassHandle theHandle) throws FederateInternalError;

	// 5.13
	void turnInteractionsOff(InteractionClassHandle theHandle) throws FederateInternalError;
...
////////////////////////////////
	...
	// 6.6
	void multipleObjectInstanceNameReservationSucceeded(Set<String> objectNames) throws FederateInternalError;

	// 6.6
	void multipleObjectInstanceNameReservationFailed(Set<String> objectNames) throws FederateInternalError;
	...
	// 6.24
	void confirmAttributeTransportationTypeChange(ObjectInstanceHandle theObject, AttributeHandleSet theAttributes,
			TransportationTypeHandle theTransportation) throws FederateInternalError;

	// 6.26
	void reportAttributeTransportationType(ObjectInstanceHandle theObject, AttributeHandle theAttribute,
			TransportationTypeHandle theTransportation) throws FederateInternalError;
	...
	// 6.30
	void reportInteractionTransportationType(FederateHandle theFederate, InteractionClassHandle theInteraction,
			TransportationTypeHandle theTransportation) throws FederateInternalError;
...
///////////////////////////////////
	...
	// 7.18
	void attributeIsNotOwned(ObjectInstanceHandle theObject, AttributeHandle theAttribute) throws FederateInternalError;
...
//////////////////////////////
	...
	// 8.3
	void timeRegulationEnabled(LogicalTime time) throws FederateInternalError;

	// 8.6
	void timeConstrainedEnabled(LogicalTime time) throws FederateInternalError;

	// 8.13
	void timeAdvanceGrant(LogicalTime theTime) throws FederateInternalError;
