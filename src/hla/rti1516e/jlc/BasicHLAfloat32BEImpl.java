...
/**
 * Implementation of an HLAfloat on 32 bytes, encoded in Big Endian The value is
...
public class BasicHLAfloat32BEImpl extends DataElementBase implements HLAfloat32BE {
	...
	/**
	 * Returns the octet boundary of this element. float32BEI octet boundary is
	...
	/**
	 * Returns the size in bytes of this element's encoding. float32BEI size is
	 * defined to 4 in the HLA standard
	 * 
