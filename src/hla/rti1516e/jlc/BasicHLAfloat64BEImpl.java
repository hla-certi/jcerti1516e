...
/**
 * Implementation of an HLAfloat on 64 bytes, encoded in Big Endian The value is
...
public class BasicHLAfloat64BEImpl extends DataElementBase implements HLAfloat64BE {
	...
	/**
	 * Returns the octet boundary of this element. float64BE octet boundary is
	...
	/**
	 * Returns the size in bytes of this element's encoding. float64BE size is
	 * defined to 8 in the HLA standard
	 * 
	...
	public void decode(ByteWrapper byteWrapper) throws DecoderException {
		...
		long d_as_l = (((long) buffer[0] << 56) | ((long) (buffer[1] & 255) << 48) | ((long) (buffer[2] & 255) << 40)
