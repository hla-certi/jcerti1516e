...
/**
 * Implementation of an HLAfloat on 64 bytes, encoded in Little Endian The value
...
public class BasicHLAfloat64LEImpl extends DataElementBase implements HLAfloat64LE {
	...
	/**
	 * Returns the octet boundary of this element. float64LE octet boundary is
	...
	/**
	 * Returns the size in bytes of this element's encoding. float64LE size is
	 * defined to 8 in the HLA standard
	 * 
	...
	public void decode(ByteWrapper byteWrapper) throws DecoderException {
		...
		long d_as_l = (((long) buffer[7] << 56) | ((long) (buffer[6] & 255) << 48) | ((long) (buffer[5] & 255) << 40)
