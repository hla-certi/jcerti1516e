...
/**
 * Implementation of an HLAinteger on 32 bytes, encoded in Little Endian The
 * value is represented by a int
 */
public class BasicHLAinteger32LEImpl extends DataElementBase implements HLAinteger32LE {

	private int value;

	/**
	 * Empty constructor to create a new BasicHLAinteger32LE
	 */
	...
	/**
	 * Constructor to create a HLAinteger32LE with a value i
	 * 
	 * @param value : value of the HLAinteger32LE, in integer
	 */
	public BasicHLAinteger32LEImpl(int i) {
		this.value = i;
	}

	/**
	 * Returns the octet boundary of this element. HLAinteger32LE octet boundary is
	...
	/**
	 * Get the value in byte of the HLAinteger32LE
	 * 
	 * @return value in byte of the HLAinteger32LE
	 */
	@Override
	public int getValue() {
		return value;
	...
	/**
	 * Change the value of the HLAinteger32LE
	 * 
