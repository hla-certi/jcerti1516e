...
/**
 * Implementation of an HLAinteger on 64 bytes, encoded in Big Endian The value
 * is represented by a long
 */
public class BasicHLAinteger64BEImpl extends DataElementBase implements HLAinteger64BE {
	...
	/**
	 * Returns the octet boundary of this element. HLAinteger64BE octet boundary is
	...
	/**
	 * Returns the size of this element's encoding. integer64BE size is defined to 8
	 * in the HLA standard
	 * 
