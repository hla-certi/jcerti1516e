...
/**
 * Implementation of an HLAASCIIstring The value of the HLAASCIIstring is
 * represented by a String
 */
public class HLAASCIIstringImpl extends DataElementBase implements hla.rti1516e.encoding.HLAASCIIstring {
	...
	/**
	 * Returns the octet boundary of this element. HLAASCIIstring octet boundary is
	...
	/**
	 * Encodes this element into the specified ByteWrapper. Convert the String value
	 * in byte array and put it in the byteWrapper's buffer
	 * 
	...
	/**
	 * Returns the size in bytes of this element's encoding. HLAASCIIstring size is
	 * defined to 4 (to encode the size) + the lenght of the string
	 * 
	...
	/**
	 * Decodes this element from the ByteWrapper. Get the bytes in the
	 * byteWrapperBuffer and convert them in a new String
	 * 
