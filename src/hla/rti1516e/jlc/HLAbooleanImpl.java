...
/**
 * Implementation of an HLAboolean
 * The value of the HLAboolean is represented by a BasicHLAinteger32BE
 * The value BasicHLAinteger32BE is set to 1 for true and 0 for false
 */
public class HLAbooleanImpl extends DataElementBase implements
    ...
    /**
     * Empty Constructor of a HLAbooleanImpl
     * Set the value to a new BasicHLAinteger32BEImpl set to 0
     */
    ...
    /**
     * Empty Constructor of a HLAbooleanImpl
     * Set the value to a new BasicHLAinteger32BEImpl set to b
     ...
     * HLAboolean octet boundary is defined to the attribute value octet boundary
	 ...
	 * Call the encode value of the attribute value
     ...
     * HLAboolean size is defined to the encoded lenght of the atribute "value"
