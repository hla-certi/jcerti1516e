...
/**
 * Implementation of HLAfloat64Interval
 * The time value is represented on a HLAfloat64BE value
 */
public class HLAfloat64IntervalImpl implements HLAfloat64Interval{
	...
	/**
	 * Compare the value of the HLAfloat64Interval to epsilon (resoluation de l'float)
	...
	/**
	 * Create a new HLAfloat64Interval witch value is the difference between this and addend
	...
	/**
	 * Compare the value of this HLAfloat64Interval the value of the HLAfloat64Interval other
