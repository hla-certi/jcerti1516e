...
public class HLAfloat64TimeImpl implements HLAfloat64Time {
	...
	private static final long serialVersionUID = -3473708294638432364L;
		...
		/**
		 * Create a new HLAfloat64Time whitch is the sum of the HLAfloat64Time and the one in parameter
		 * @param val : HLAfloat64Time to add 
		 * @return : a new HLAfloat64Time whitch is the sum of the HLAfloat64Time and the one in parameter
		 */
		@Override
		...
		/**
		 * Create a new HLAfloat64Time whitch is the difference of the HLAfloat64Time and the one in parameter
		 * @param val : HLAfloat64Time to add 
		 * @return : a new HLAfloat64Time whitch is the difference of the HLAfloat64Time and the one in parameter
		 */
		@Override
		...
		/**
		 * Compare the value of this HLAfloat64Time the value of the HLAfloat64Time other
