...
/**
 * Implementation of HLAinteger64Interval The time value is represented on a
...
public class HLAinteger64IntervalImpl implements HLAinteger64Interval {
	...
	/**
	 * Compare the value of the HLAinteger64Interval to epsilon (resolution de
	 * l'integer)
	 * 
	...
	/**
	 * Create a new HLAinteger64Interval witch value is the difference between this
	 * and addend
	 * 
	...
	public HLAinteger64Interval subtract(HLAinteger64Interval subtrahend)
		...
		HLAinteger64Interval integer64Interval = new HLAinteger64IntervalImpl(
				this.time.getValue() - subtrahend.getValue());
		return integer64Interval;
	}

	/**
	 * Compare the value of this HLAinteger64Interval the value of the
	 * HLAinteger64Interval other
	 * 
