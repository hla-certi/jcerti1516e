...
public class UavSend {
	...
	public void runFederate() throws Exception {
		...
		while (i-- > 0) {
			...
			System.out.println("     6.1 UAV with time="
					+ ((CertiLogicalTime) (((MyFederateAmbassador) mya).updateTime)).getTime());
			rtia.updateAttributeValues(myObject, attributes, tag, ((MyFederateAmbassador) mya).updateTime);

			System.out.println("     6.2 TAR with time="
	...
	private class MyFederateAmbassador extends NullFederateAmbassador {
		...
		public void initialize(RTIambassador rtia) throws NameNotFound, FederateNotExecutionMember, RTIinternalError,
				ObjectClassNotDefined, AttributeNotDefined, OwnershipAcquisitionPending, SaveInProgress,
				RestoreInProgress, AsynchronousDeliveryAlreadyEnabled, EnableTimeRegulationPending,
				EnableTimeConstrainedPending, TimeConstrainedAlreadyEnabled, TimeRegulationAlreadyEnabled,
				ConcurrentAccessAttempted, ObjectClassNotPublished, ObjectAlreadyRegistered,
