 ...
 * launches the rtig (if it is not running), creates and joins a federation
 * called TimeAdvanceTAR, and kill the rtig process (if launched by this
 * federate). The FOM file is a string.
 * </p>
 * <p>
