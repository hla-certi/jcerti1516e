...
public class UavReceiveString {
    
    private final static Logger LOGGER = Logger.getLogger(UavReceiveString.class.getName());
   // private static final double stopTime = 50; //If used in "RAV loop"
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            new UavReceiveString().runFederate(timeStepArg, updateTimeArg, lookahead);
        } catch(NumberFormatException exception) {
            new UavReceiveString().runFederate(10.0, 0.2, 0.1);
        }
    }
