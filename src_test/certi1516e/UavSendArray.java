...
public class UavSendArray {
    ...
    public void runFederate(double timeStepArg, double uptdateTimeArg, double lookaheadArg) throws Exception {
        ...
        //while (((CertiLogicalTime1516E) mya.timeAdvance).getTime() < stopTime) {i++;
            //Array : fixed array -> array with a fixed length, all the elements have the same time, here integers
        	//See the FixedArray documentation or HLA documentation to know more about the type
        	//We have to create a new factory for the type in the array : here a factory of integer
        	DataElementFactory<HLAinteger64BE> integer64BE_Factory = new DataElementFactory<HLAinteger64BE>(){
				public HLAinteger64BE createElement(int index){ 
					//Class encoreFactory it used to create a specified factory. Like an Integer factory or a String factory
			...
			HLAfixedArray<HLAinteger64BE> fixedArray = new HLAfixedArrayImpl<HLAinteger64BE>(integer64BE_Factory, 2);
			...
			//We link the byteWrapper to the arrayAttribute to get the result from the byte[]
