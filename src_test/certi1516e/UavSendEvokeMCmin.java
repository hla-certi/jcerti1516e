...
public class UavSendEvokeMCmin {

    private final static Logger LOGGER = Logger.getLogger(UavSendEvokeMCmin.class.getName());
    ...
    public void runFederate(double timeStepArg, double uptdateTimeArg, double lookaheadArg) throws Exception {
        ...
        if (mya.isCreator){
            ...
            while(!mya.synchronizationSuccess && ! mya.synchronizationFailed){
                LOGGER.info(" SP succeeded evokeCallback(" + BLOCKING_TIME);
        ...
        {
            LOGGER.info(" federationSynchronized evokeCallback(" + BLOCKING_TIME);
            rtia.evokeCallback(BLOCKING_TIME);
        }
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            new UavSendEvokeMCmin().runFederate(timeStepArg, updateTimeArg, lookahead);
        } catch(NumberFormatException | ArrayIndexOutOfBoundsException exception) {
            new UavSendEvokeMCmin().runFederate(10.0, 0.2, 0.1);
        }
