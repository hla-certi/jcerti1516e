...
public class ResignFederation {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try {
                ...
                LOGGER.info("2. Trying to resign without joinning the federation - Exception FederateNotExecutionMember correctly caught. ");
            }
            ...
            try {
                ...
                LOGGER.info("4. Try to resign a federation we already resigned - Exception FederateNotExecutionMember correctly caught. ");
            }
    ...
    public void createFederation(){
        try {
            String fom = "uav.xml";
            rtia.createFederationExecution("uav_ResignFederation", fom);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
