...
public class Receiver {
    ...
    public boolean receive(float expectedFloat, String expectedString, LogicalTime expectedTime)
        ...
        SendandReceiveValues_TAR.LOGGER.info("Receiver .........6.1 TAR with time=" + ((CertiLogicalTime1516E) mya_receive.timeAdvance).getTime());
        ...
        try
        {
            while(federationIsActive){
                try{
                    ...
                    SendandReceiveValues_TAR.LOGGER.info("Receiver ......... Federates currently joined - can't destroy the execution. Wait some time and try again to destroy the federation.");
                    Thread.sleep(1000);
