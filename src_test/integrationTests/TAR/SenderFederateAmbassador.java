...
public class SenderFederateAmbassador extends NullFederateAmbassador {
    ...
    /**
                ...
                ObjectInstanceNameNotReserved
        {
            ...
            SendandReceiveValues_TAR.LOGGER.info("     4.5. Set time management configuration (Regulator with lookahed and Constrained)");
        ...
        public void discoverObjectInstance(ObjectInstanceHandle theObject, ObjectClassHandle theObjectClass,
            ...
            SendandReceiveValues_TAR.LOGGER.info("Discover Object Instance : "
        ...
        public void timeAdvanceGrant(LogicalTime theTime) throws FederateInternalError {
            ...
            SendandReceiveValues_TAR.LOGGER.info("Sender ------- 6.3 TAG with time = " + ((CertiLogicalTime1516E) theTime).getTime());
