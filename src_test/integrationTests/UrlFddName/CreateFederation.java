...
public class CreateFederation {
	...
	public static void main(String[] args) {
		...
		try {
			...
			try {
				test.rtia.createFederationExecution("uav_CreateFederation", fdd.toURI().toURL());
			...
			try {
				...
				File fdd_error = new File("error.xml");
				test.rtia.createFederationExecution("uav_CreateFederation_fomError", fdd_error.toURI().toURL());
