...
public class ReceiverFederateAmbassador extends NullFederateAmbassador {
                ...
                throws FederateInternalError
        {
            try {
                ...
                System.out.println(" RAV with time= " + ((CertiLogicalTime1516E)theTime).getTime());
                for(AttributeHandle attributeHandle : attributeHandleSet){
                    if(attributeHandle.hashCode() == textAttributeHandle.hashCode()){
                        ...
                        value.decode(bw);
                        System.out.println("     --> Attribute text : " + value.getValue());
                        if(!value.getValue().equals(expectedString)){
                            System.out.println("******* TEST FAILED - String value is not expected value: received value = "
                            ...
                            System.out.println("******* TEST FAILED - RAV Receive at wrong time, expected at  "
                    ...
                    if(attributeHandle.hashCode() == fomAttributeHandle.hashCode()){
                        ...
                        ByteWrapper bw = theAttributes.getValueReference(attributeHandle);
                        value.decode(bw);
                        System.out.println("     --> Attribute fom : " + value.getValue());
                        if(value.getValue() != expectedFloat){
                            System.out.println("******* TEST FAILED - Float value is not expected value: received value = "
                            ...
                            System.out.println("******* TEST Float PASSED");
                        }
        ...
        public void timeAdvanceGrant(LogicalTime theTime) throws FederateInternalError {
            ...
            System.out.println("Receiver .........6.2 TAG with time=" + ((CertiLogicalTime1516E) theTime).getTime());
            System.out.println("\n");
