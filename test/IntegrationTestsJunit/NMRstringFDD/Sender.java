...
public class Sender {
    ...
    public boolean send(float expectedFloat, String expectedString, LogicalTime updateTime) throws IOException, InterruptedException {
        ...
        try {
            System.out.println("Sender ------- 2. Create federation- " + federationExecutionName);
...
//            rtia_send.joinFederationExecution(federateName, federateType, federationExecutionName);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
