...
class ComplexeTypeEncoding_Test {
	...
	public void  FixedArrayTest_Integer64BE() {
		...
		try {
			...
			integer64BE_Factory = new DataElementFactory<HLAinteger64BE>(){
				public HLAinteger64BE createElement(int index){ return encoderFactory.createHLAinteger64BE();}
			};
			...
			HLAfixedArray<HLAinteger64BE> hlafixedArray_encode = new HLAfixedArrayImpl<HLAinteger64BE>(integer64BE_Factory, 2);
			...
			HLAfixedArray<HLAinteger64BE> hlafixedArray_decode = new HLAfixedArrayImpl<HLAinteger64BE>(data);
	...
	public void  FixedArrayTest_Float64BE() {
		...
		try {
			...
			float64BE_Factory = new DataElementFactory<HLAfloat64BE>(){
				public HLAfloat64BE createElement(int index){ return encoderFactory.createHLAfloat64BE();}
			};
			...
			HLAfixedArray<HLAfloat64BE> hlafixedArray_encode = new HLAfixedArrayImpl<HLAfloat64BE>(float64BE_Factory, 2);
			...
			HLAfixedArray<HLAfloat64BE> hlafixedArray_decode = new HLAfixedArrayImpl<HLAfloat64BE>(data);
			
			
			hlafixedArray_decode.decode(byteWrapper);
			
			 Assert.assertEquals(hlafixedArray_encode.get(0).getValue(), hlafixedArray_decode.get(0).getValue(),Math.ulp(1.0));
			 Assert.assertEquals(hlafixedArray_encode.get(0).getValue(), hlafixedArray_decode.get(0).getValue(),Math.ulp(1.0));
			 Assert.assertEquals(hlafixedArray_decode.get(0).getValue(), -1,Math.ulp(1.0));

			 Assert.assertEquals(hlafixedArray_encode.get(1).getValue(), hlafixedArray_decode.get(1).getValue(),Math.ulp(1.0));
	...
	public void  FixedArrayTest_Float32BE() {
		...
		try {
			...
			float32BE_Factory = new DataElementFactory<HLAfloat32BE>(){
				public HLAfloat32BE createElement(int index){ return encoderFactory.createHLAfloat32BE();}
			};
			...
			HLAfixedArray<HLAfloat32BE> hlafixedArray_encode = new HLAfixedArrayImpl<HLAfloat32BE>(float32BE_Factory, 2);
			...
			HLAfixedArray<HLAfloat32BE> hlafixedArray_decode = new HLAfixedArrayImpl<HLAfloat32BE>(data_decode);
			hlafixedArray_decode.decode(byteWrapper);
	...
	public void  VariableArrayTest_Float32BE() {
		...
		try {
			...
			HLAvariableArray<HLAfloat32BE> hlavariableArray_encode = new HLAvariableArrayImpl<HLAfloat32BE>(float32BE_Factory, 2);
			...
			byteWrapper.reset();
			HLAvariableArray<HLAfloat32BE> hlavariableArray_decode = new HLAvariableArrayImpl<HLAfloat32BE>(float32BE_Factory, 2);
			hlavariableArray_decode.decode(byteWrapper);
			
			 Assert.assertEquals(hlavariableArray_encode.get(0).getValue(), hlavariableArray_decode.get(0).getValue(), Math.ulp(1.0));
			 Assert.assertEquals(hlavariableArray_encode.get(1).getValue(), hlavariableArray_decode.get(1).getValue(), Math.ulp(1.0));
	...
	public void  VariableArrayTest_Float64BE() {
		...
		try {
			...
			HLAvariableArray<HLAfloat64BE> hlavariableArray_encode = new HLAvariableArrayImpl<HLAfloat64BE>(float64BE_Factory, 2);
			...
			byteWrapper.reset();
			HLAvariableArray<HLAfloat64BE> hlavariableArray_decode = new HLAvariableArrayImpl<HLAfloat64BE>(float64BE_Factory, 2);
			hlavariableArray_decode.decode(byteWrapper);
	...
	public void  VariableArrayTest_VariantRecord() {
		...
		try {
			...
			HLAvariantRecord<HLAoctet> variantEncoder_1 = new HLAvariantRecordImpl<HLAoctet>();
			...
			HLAvariantRecord<HLAoctet> variantEncoder_2 = new HLAvariantRecordImpl<HLAoctet>();
			variantEncoder_2.setVariant(discriminantEncoder_2, valueEncoder_2);
			
			
			HLAvariableArray<HLAvariantRecord<HLAoctet>> hlavariableArray_encode = new HLAvariableArrayImpl<HLAvariantRecord<HLAoctet>>();
			...
			HLAvariantRecord<HLAoctet> variantDecoder_1 = new HLAvariantRecordImpl<HLAoctet>();
			...
			HLAvariantRecord<HLAoctet> variantDecoder_2 = new HLAvariantRecordImpl<HLAoctet>();
			variantDecoder_2.setVariant(discriminantDecoder_2, valueDecoder_2);
			
			HLAvariableArray<HLAvariantRecord<HLAoctet>> hlavariableArray_decode = new HLAvariableArrayImpl<HLAvariantRecord<HLAoctet>>();
	...
	public void  FixedRecordTest() {
		...
		try {
			...
			hlafixedRecord_decode.decode(byteWrapper);
			 ...
			 Assert.assertEquals(((HLAfloat32BE) hlafixedRecord_encode.get(0)).getValue(), ((HLAfloat32BE) hlafixedRecord_decode.get(0)).getValue(), Math.ulp(1.0));
			 Assert.assertEquals(((HLAinteger32BE) hlafixedRecord_encode.get(1)).getValue(), ((HLAinteger32BE) hlafixedRecord_decode.get(1)).getValue());
			 Assert.assertEquals(((HLAinteger64LE) hlafixedRecord_encode.get(2)).getValue(), ((HLAinteger64LE) hlafixedRecord_decode.get(2)).getValue());
			// Assert.assertEquals(((HLAinteger64LE) hlafixedRecord_encode.get(3)).getValue(), ((HLAinteger64LE) hlafixedRecord_decode.get(3)).getValue());
			...
			// Assert.assertEquals(((HLAinteger64LE) hlafixedRecord_decode.get(3)).getValue(), (float) 1.2);
	...
	void VariantRecordTest_1value() {
		try {
			...
			HLAvariantRecord<HLAoctet> variantEncoder = new HLAvariantRecordImpl<HLAoctet>();
			...
			HLAvariantRecord<HLAoctet> variantDecoder = new HLAvariantRecordImpl<HLAoctet>();
